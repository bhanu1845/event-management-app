...
          {/* Desktop nav (visible on md+) - UPDATED WITH SERVICES AND PORTFOLIO */}
          <div className="hidden md:flex items-center gap-4">
            
            {/* CORE LINKS FOR EVENT SERVICES */}
...
                {/* Mobile links - UPDATED WITH <Link> FOR CART, SERVICES, AND PORTFOLIO */}
                
                {/* Cart Link (changed from button to Link) */}
                <Link
                  to="/cart"
...
                </Link>
                
                {/* NEW CORE LINKS FOR EVENT SERVICES */}
                <Link to="/services" onClick={() => setIsOpen(false)} className="text-lg font-medium hover:text-primary transition-colors">
                  Services
                </Link>
                <Link to="/portfolio" onClick={() => setIsOpen(false)} className="text-lg font-medium hover:text-primary transition-colors">
                  Portfolio
                </Link>
                {/* END OF NEW CORE LINKS */}
